...
variable "vsts_accesstoken" {
    type = string
    description = "vsts_accesstoken"
}

variable "vsts_server_url" {
    type = string
    description = "vsts_server_url"
}

variable "vsts_poolname" {
    type = string
    description = "vsts_poolname"
}

variable "vsts_agent_name" {
    type = string
    description = "vsts_agent_name"
}
